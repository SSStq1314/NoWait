...
#import "LabelDl.h"
#import "AddOper.h"
@interface OtherViewController ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>{
    AddOper* op;
...
-(void)store{
    if ([_content.text isEqualToString:@""]) {
        ...
        Content* con=[[Content alloc]initWithWord:_content.text Date:_date.text TextFont:[NSNumber numberWithInt:16] BackGround:@"123" Label:dl.la ImaArr:arr Weather:nil];
